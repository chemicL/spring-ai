...
@SpringBootTest(classes = OpenAiObservationSimpleIT.Config.class)
@EnabledIfEnvironmentVariable(named = "OPENAI_API_KEY", matches = ".+")
@ActiveProfiles("logging-test")
class OpenAiObservationSimpleIT {

	private static final Logger logger = LoggerFactory.getLogger(OpenAiObservationSimpleIT.class);
	...
	private void streamObservationTree() {
		...
		var simpleTracer = new SimpleTracer();
		reg.observationConfig().observationHandler(new DefaultTracingObservationHandler(simpleTracer));
